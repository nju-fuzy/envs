...
class AcrobotRewardEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def __init__(self, obs_type, reward_type):
        ''' Initialize
        @Params:
            obs_type : 'RAM' returns an array with shape (6, ) [cos(theta1) sin(theta1) cos(theta2) sin(theta2) thetaDot1 thetaDot2].
                       'Image' returns an array with shape (210, 160, 3)
            reward_type :
    ...
    def step(self, a, gamma = 0.99):
        ...
        if self.reward_type == 0:
            ...
            # phi(s)
            r4 = gamma * np.dot(self.weight1, np.array(ns)) - np.dot(self.weight1, np.array(old_s))
        ...
        # image is numpy.array with shape (500, 500, 3)
    ...
    def get_reward(self, src_reward, old_state, state, done, reward_type, gamma = 0.99):
        ...
        @Params:
            ...
            state : new_state
            done : if done return 0.0 reward
            reward_type:
    ...
    def init_viewer(self, visible = False):
        ...
        if self.viewer is None:
            self.viewer = rendering.Viewer(500,500, visible = visible)
